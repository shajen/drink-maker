...
constexpr auto BUTTON_CONTROL_COLOR = ControlColor::Alizarin;
...
UiController::UiController(Settings& settings, std::function<void()> updateSettingsCallback, std::function<int()> getDistanceCallback)
    : m_settings(settings), m_updateSettingsCallback(updateSettingsCallback), m_getDistanceCallback(getDistanceCallback), m_isDebugTab(false), m_lastPrintStatusTime(0) {
  ...
  ESPUI.addControl(ControlType::Button, "default settings", "reset", BUTTON_CONTROL_COLOR, basicTab, std::bind(&UiController::resetSettings, this, _1, _2));

  createSlider(advancedTab, "distance [cm]", m_settings.m_distance, 1, 100, 1, std::bind(&UiController::saveSettings, this), m_readSettingsCallbacks);
  ...
  ESPUI.addControl(ControlType::Button, "default settings", "reset", BUTTON_CONTROL_COLOR, advancedTab, std::bind(&UiController::resetSettings, this, _1, _2));
